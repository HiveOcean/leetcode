...
public class BestTimeToBuySellStock2_LC122 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Profit: " + maxProfit(stockPrices1));
		System.out.println("Profit: " + maxProfit(stockPrices2));
		System.out.println("Profit: " + maxProfit(stockPrices3));
	}
