...
public class KidsWithTheGreatestNumberOfCandies_LC1431 {
	...
	public static void main(String[] args) {
		KidsWithTheGreatestNumberOfCandies_LC1431 gnc = new KidsWithTheGreatestNumberOfCandies_LC1431();
		
		int[] input1 = {2,3,5,1,3};
		int[] input2 = {4,2,1,1,2};
		int[] input3 = {12,1,12};
		
		for (boolean b: gnc.kidsWithCandies2(input1, 3))
			System.out.print(b + " ");
		System.out.println();
